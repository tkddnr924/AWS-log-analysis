...
export const commands = {
	 ...
	 */
	evaluateRule: (caseId: string, ruleId: string, started: Channel<null>) => typedError<number, string>(__TAURI_INVOKE("evaluate_rule", { caseId, ruleId, started })),
	/**
	 ...
	 *  the slot is held.
	 */
	countRuleMatches: (caseId: string, source: string, started: Channel<null>) => typedError<RuleHits, string>(__TAURI_INVOKE("count_rule_matches", { caseId, source, started })),
};
